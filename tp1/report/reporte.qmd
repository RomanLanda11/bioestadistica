...
dd <- read_excel("C:/Escritorio/FACULTAD/5° año 1° cuatrimestre/Bioestadística/bioestadistica/tp1/datos/dd.xlsx")
...
#| message: false
#| warning: false
adm <- read_excel("C:/Escritorio/FACULTAD/5° año 1° cuatrimestre/Bioestadística/bioestadistica/tp1/datos/adm.xlsx") %>%
  mutate(
...
#write_xlsx(validacion, "C:/Escritorio/FACULTAD/5° año 1° cuatrimestre/Bioestadística/bioestadistica/validacion_resultados.xlsx")

```
![](C:/Escritorio/FACULTAD/5° año 1° cuatrimestre/Bioestadística/bioestadistica/tp1/valid.png.jpeg)
...
# write_xlsx(errores_por_registro, "C:/Escritorio/FACULTAD/5° año 1° cuatrimestre/Bioestadística/bioestadistica/erroresxreg.xlsx")
```

![](C:/Escritorio/FACULTAD/5° año 1° cuatrimestre/Bioestadística/bioestadistica/tp1/errores x reg.jpeg)
...
# write_xlsx(errores_por_regla, "C:/Escritorio/FACULTAD/5° año 1° cuatrimestre/Bioestadística/bioestadistica/errores.xlsx")
```

![](C:/Escritorio/FACULTAD/5° año 1° cuatrimestre/Bioestadística/bioestadistica/tp1/errores.jpeg)
